/*
 * Version info:
 *     $HeadURL: https://cscs-repast-demos.googlecode.com/svn/richard/StupidModel/tags/2011_06_18_model_16/src/stupidmodel/common/CellData.java $
...
public class FarmData {
	...
	private final double anotherVariable;

	/**
	 * Shared comparator for {@link FarmData} comparison based on their
	...
	/**
	 * Simple comparator for <code>x</code> coordinates of a {@link FarmData}
	 * instance.
	 */
	private static final class CellDataXComparator implements
			Comparator<FarmData>, Serializable {
		/**
		 ...
		 */
		@Override
		public int compare(final FarmData o1, final FarmData o2) {
			return (int) (o1.getX() - o2.getX());
		}
	}

	/**
	 * Simple comparator for <code>y</code> coordinates of a {@link FarmData}
	 * instance.
	 */
	...
	/**
	 * Create a new instance of {@link FarmData} with the specified arguments.
	 * 
	 * <p>
	 ...
	 *            non-negative</i>
	 */
	public FarmData(final double x, final double y, final double foodProductionRate, final double variable) {
		super();
	...
	public boolean equals(final Object obj) {
		if (obj instanceof FarmData) {
			final FarmData other = (FarmData) obj;
